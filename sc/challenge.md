...
Something I appreciate is an eye toward style. For example, if my Python files
are not PEP8, I would appreciate it if my reviewer would mention that.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

Containers can help to automate the creation of servers to perform certain
tasks. That way, we will understand what is running where.
